...
% Formal SVK
\includegraphics[width=1.0\textwidth]{docs/zadanie_Bahyl_SVK.pdf}
\newpage
...
% Chapters
\input{chap1_theory}
\input{chap2_exp-setup}
\input{chap3_results-exp}
\input{chap4_simulations}
\input{chap5_conclusions}
